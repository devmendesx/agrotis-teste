...
public class LaboratoryService {
    ...
    public List<LaboratoryViewDto> findAll() {
        try {
            ...
            return laboratories.stream().map(lab -> LaboratoryViewDto.builder().id(lab.getId()).name(lab.getName()).cod(lab.getCodLaboratory()).build()).collect(Collectors.toList());
    ...
    public LaboratoryViewDto findByCodLaboratory(UUID cod) {
        try {
            ...
            return LaboratoryViewDto.builder()
                    ...
                    .cod(laboratory.get().getCodLaboratory())
                    .build();
        } catch (ResponseStatusException exception){
    ...
    public MessageResponseDto delete(UUID codLaboratory) {
        try {
            ...
            return MessageResponseDto.builder()
                    .message("Erro ao tentar deletar o laboratório informado.")
                    .build();
        }
    }

    @Transactional
    public MessageResponseDto updateName(LaboratoryUpdateDto labDto) {
        try {
            ...
            return MessageResponseDto.builder()
                    .message("Erro ao tentar atualizar o laboratório informado.")
                    .build();
        }
    }
